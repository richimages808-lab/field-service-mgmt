...
export const HELP_ARTICLES: HelpArticle[] = [
    ...
    },
    {
        ...
        category: 'getting-started',
        content: `Customize your DispatchBox workspace by enabling or disabling key operational modules and specific sub-features based on your business needs. You can configure these during onboarding or update them at any time from your settings.
...
- **Custom Quotes:** Quote Builders continue to let technicians type custom line-items and descriptions manually, even without active materials or parts catalog databases.`,
    ...
    },
    {
        ...
        keywords: ['quote', 'change request', 'revision', 'ai quote', 'dashboard', 'communication history', 'timeline', 'tech review', 'approve revision', 'regenerate ai']
    },
    {
...
4. Click **Send** to post. The note instantly appears in the chronologically ordered activity list.`,
        lastUpdated: '2026-06-05',
        keywords: ['quote', 'navigation', 'menus', 'messages', 'notes', 'timeline', 'customer portal', 'communication', 'post-approval', 'discussion']
    },
    {
...
- **Customer-Facing Timelines** ── Filter out all free-form technician messages (\`isInternal={false}\`), keeping internal notes hidden, while preserving customer notes, status updates, and price revision events.`,
        lastUpdated: '2026-06-05',
