import{j as e,C as p,r as w,X as S,c0 as A,o as U,f as P,g as T,P as I,F as D,h as E,c1 as O,c2 as R,c3 as g,k as M,a as B,G as q,ae as V}from"./ui-CV7Ai9bp.js";import{r as n}from"./vendor-DJjfIQIo.js";import{h as L,q as z,j as F,B as G}from"./firebase-DgIH8nZb.js";import{u as J,d as W}from"./index-BVkxsPRG.js";const y=[{id:"getting-started",name:"Getting Started",icon:"Rocket",description:"First steps with DispatchBox"},{id:"jobs",name:"Jobs & Scheduling",icon:"Calendar",description:"Creating and managing service jobs"},{id:"invoicing",name:"Invoicing & Quotes",icon:"FileText",description:"Billing your customers"},{id:"inventory",name:"Inventory",icon:"Package",description:"Materials and tools tracking"},{id:"customers",name:"Customers & Portal",icon:"Users",description:"Customer management and self-service portal"},{id:"addons",name:"Add-on Services",icon:"Puzzle",description:"Domain, Email, SMS, and AI Phone"},{id:"reports",name:"Reports & Analytics",icon:"BarChart2",description:"Business insights and data"},{id:"account",name:"Account & Billing",icon:"CreditCard",description:"Your plan, profile, and billing"}],$=[{id:"gs-first-login",title:"Your First Login",category:"getting-started",content:`After signing up, you'll land on your dashboard. Here's what to do first:
