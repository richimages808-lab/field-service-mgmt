import{j as e,X as x,h as y,E as C,cH as j,x as D,o as P,U as E,P as N,F as R,d as M,cI as U,cJ as W,cK as b,t as F,f as Q,g as O,aq as B}from"./ui-CpYUsvYM.js";import{r as s}from"./vendor-DJjfIQIo.js";import{h as H,q as L,j as z,t as V}from"./firebase-nL4IAe1c.js";import{u as G,d as J}from"./index-bkcKzl2o.js";const f=[{id:"getting-started",name:"Getting Started",icon:"Rocket",description:"First steps with DispatchBox"},{id:"jobs",name:"Jobs & Scheduling",icon:"Calendar",description:"Creating and managing service jobs"},{id:"communications",name:"Communications Hub",icon:"MessageSquare",description:"Unified inbox for all customer inquiries"},{id:"invoicing",name:"Invoicing & Quotes",icon:"FileText",description:"Billing your customers"},{id:"inventory",name:"Inventory",icon:"Package",description:"Materials and tools tracking"},{id:"customers",name:"Customers & Portal",icon:"Users",description:"Customer management and self-service portal"},{id:"addons",name:"Add-on Services",icon:"Puzzle",description:"Domain, Email, SMS, and AI Phone"},{id:"reports",name:"Reports & Analytics",icon:"BarChart2",description:"Business insights and data"},{id:"account",name:"Account & Billing",icon:"CreditCard",description:"Your plan, profile, and billing"}],Y=[{id:"gs-first-login",title:"Your First Login",category:"getting-started",content:`After signing up, you'll land on your dashboard. Here's what to do first:

1. **Complete your profile** â€” Click your avatar in the top-right corner and select "Your Profile" to add your photo, phone number, and details.

2. **Set up your organization** â€” Go to Organization Settings to add your company logo, set your primary color theme, and configure your email prefix.

3. **Explore the dashboard** â€” Your dashboard shows today's jobs, upcoming appointments, and key business metrics at a glance.`,lastUpdated:"2026-03-11",keywords:["login","first","start","setup","begin","new"]},{id:"gs-create-first-job",title:"Creating Your First Job",category:"getting-started",content:`To create a new service job:
...
**Presentation Modes:**
- **Detailed Line Items** â€” Shows every part, labor, and service line item with its individual quantity and price. Best for transparent pricing.
- **Roll-up by Category** â€” Groups your line items by their category (e.g., Labor, Materials, Travel) and shows only category subtotals. Great for simpler presentations.
- **Single Price Summary** â€” Hides all line items and category subtotals. Displays just one single "Complete Service" line with the total cost. Ideal for fixed-bid jobs.

**Tax & Discount Controls:**
- **Display Tax Toggle** â€” Choose whether to show Tax as a separate line item or hide it from the summary.
- **Discount Flexibility** â€” Add discounts as a fixed dollar amount ($) or a percentage (%) of the subtotal. You can also add an optional Reason (e.g., "First-time customer discount") that will be visible to the customer.
...
Upgrade anytime from **Organization Settings**. Changes take effect immediately.`,lastUpdated:"2026-03-11",keywords:["plan","pricing","upgrade","subscription","tier"]},{id:"acct-org-settings",title:"Organization Settings",category:"account",content:`Configure your organization from the profile menu â†’ **Organization Settings**:
...
- **Tax Rate** â€” Set your default tax rate for invoices.
- **Plan Management** â€” View current plan and upgrade options.`,lastUpdated:"2026-04-13",keywords:["settings","organization","company","branding","configure","upload","logo"]},{id:"po-workflow",title:"Purchase Orders & Shopping Cart",category:"inventory",content:`Manage your purchasing directly in DispatchBox:
...
You can configure a global email signature that automatically appends to all outgoing emails (including automated notifications and custom composed emails).
1. Go to **Organization Settings → Email Settings**
2. Scroll to **Email Signature** and enable it
3. Enter your signature template (HTML is supported!)

## Mailbox Filtering

Each alias you configure in **Organization Settings → Email Settings** appears as a separate mailbox. Select a mailbox to see only emails sent to that address, or use **All Mail** to see everything.

Unread counts are shown per-mailbox so you can quickly spot which department has new messages.

## Reading & Managing Emails

- **Star** important emails for quick reference
- **Archive** emails you've handled to keep your inbox clean
- **Mark Unread** to flag an email for follow-up
- **View Ticket** jumps directly to the linked job/ticket if one was auto-created

## Replying

Click **Reply** at the bottom of the reading pane to compose a response. Replies are sent automatically from the same alias address that the customer originally sent their email to.

## Search

Use the search bar to find emails by sender, subject, or body content across all mailboxes.`,lastUpdated:new Date().toISOString().split("T")[0],keywords:["email","inbox","mailbox","read","reply","compose","send","archive","star","search","inbound","outbound","messages"]},{id:"portal-appointment-scheduling",title:"Portal Intents & Appointment Scheduling",category:"customers",content:`Your public portal now supports **four distinct customer intents** — matching the same workflow your AI Voice Agent uses. Customers no longer need to sign in for any of these actions.
...
- **Email/SMS**: When quotes, invoices, or appointment reminders are sent.
- **Manage Appointments**: Legacy bookings get tokens auto-generated on lookup.

## For Administrators

Tokens are stored in the \`access_tokens\` Firestore collection. Each token document includes the resource type, ID, org, customer info, permissions, and a full access log.
