...
- **Plan Management** — View current plan and upgrade options.`,lastUpdated:new Date().toISOString().split("T")[0],keywords:["settings","organization","company","branding","configure","upload","logo","signature","email signature"]},{id:"po-workflow",title:"Purchase Orders & Shopping Cart",category:"inventory",content:`Manage your purchasing directly in DispatchBox:
